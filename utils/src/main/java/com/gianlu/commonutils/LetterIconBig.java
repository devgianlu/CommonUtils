...
public class LetterIconBig extends View {
    ...
    public void setColorScheme(@ColorRes int colorAccent, @ColorRes int colorPrimary, @ColorRes int colorPrimary_shadow) {
        ...
        textPaint = new Paint();
        textPaint.setColor(ContextCompat.getColor(getContext(), colorPrimary));
